...
<div class="inner_center_top">
    <div class="dept_div">
        <span>部门名称</span>
        <input type="text" placeholder="请输入部门名称" class="input dept_name"/>
    </div>
    <div class="dept_div">
        <span>部门主管</span>
        <input type="text" placeholder="请输入部门主管ID" class="input dept_mana"/>
    </div>
    <div class="dept_div">
        <span>部门编号</span>
        <input type="text" placeholder="请输入部门编号" class="input dept_code"/>
    </div>
