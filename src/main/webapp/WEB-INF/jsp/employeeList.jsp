...
<div class="edit">
    ...
    <div class="dept_div">
        <span>员工姓名</span>
        <input type="text" placeholder="请输入员工姓名" class="input"/>
    </div>
    <div class="dept_div">
        <span>出生日期</span>
        <input type="text" placeholder="请输入出生日期" class="input"/>
    </div>
    <div class="dept_div">
        <span>性别</span>
        <input type="text" placeholder="请输入性别" class="input"/>
    </div>
    <div class="dept_div">
        <span>工作岗位</span>
        <input type="text" placeholder="请输入工作岗位" class="input"/>
    </div>
    <div class="dept_div">
        <span>上岗日期</span>
        <input type="text" placeholder="请输入上岗日期" class="input"/>
    </div>
    <div class="dept_div">
        <span>主管</span>
        <input type="text" placeholder="请输入主管" class="input"/>
    </div>
    <div class="dept_div">
        <span>基本工资</span>
        <input type="text" placeholder="请输入基本工资" class="input"/>
    </div>
    <div class="dept_div">
        <span>补贴</span>
        <input type="text" placeholder="请输入补贴" class="input"/>
    </div>
    <div class="dept_div">
        <span>部门编号</span>
